              ...
              {websiteProjects.map((project) => {
                ...
                return (
                  <motion.div
                    key={project.id}
                    variants={cardVariants}
                    className="group flex flex-col bg-white border border-gray-200 rounded-[5px] overflow-hidden hover:border-gray-400 hover:shadow-xl hover:shadow-neutral-100 transition-all duration-300 cursor-pointer"
