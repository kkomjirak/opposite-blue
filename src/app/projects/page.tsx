          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                className="group cursor-pointer rounded-[5px] border border-gray-300 bg-white overflow-hidden hover:border-gray-400 hover:shadow-2xl hover:shadow-neutral-200/50 transition-all duration-500 flex flex-col justify-between"
              >
              ...
              {websiteProjects.map((project) => {
                ...
                return (
                  <motion.div
                    key={project.id}
                    variants={cardVariants}
                    className="group flex flex-col bg-white border border-gray-300 rounded-[5px] overflow-hidden hover:border-gray-400 hover:shadow-xl hover:shadow-neutral-100 transition-all duration-300 cursor-pointer"
            ...
            <div className="overflow-y-auto flex-1 p-6 space-y-8">
              ...
              {activeModalProject.images.length > 0 && (
                <div className="space-y-4">
                  <div className="relative bg-neutral-50 rounded-[5px] border border-gray-300 overflow-hidden flex items-center justify-center min-h-[300px] max-h-[560px]">
                    <img
