      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 pt-16 md:pt-24 pb-16 md:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-[5px] overflow-hidden border border-gray-100 bg-neutral-50 shadow-xl shadow-neutral-100 group">
            ...
            {featuredProjects.map((p) => {
              ...
              return (
                <Link
                  key={p.id}
                  href="/projects"
                  className="group block rounded-[5px] overflow-hidden border border-gray-100 bg-white hover:shadow-xl transition-all duration-300"
                >
